...
describe('PerformScript', () => {
  ...
  it('should allow custom parameter and fm script option', () => {
    ...
    expect(arg2Parsed.callbackName).toEqual(expect.stringContaining('fmGoferCallback'));
...
describe('PerformScriptWithOption', () => {
  ...
  describe('inputs and outputs', () => {
    ...
    it('should return a promise', () => {
      expect(FMGofer.PerformScriptWithOption('my script')).toBeInstanceOf(Promise);
    });
  })
})
...
describe('Wait for FM to be ready before calling', () => {
  ...
  it('should call FileMaker.PerformScriptWithOption if FM becomes ready in less than 2000 ms', () => {
    ...
    const spy = vi.fn();
    vi.useFakeTimers();
    FMGofer.PerformScriptWithOption('test script', 'test param', 3, 2000, 'lkjf');
